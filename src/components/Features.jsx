...
const BentoTilt = ({children, className = ''}) => {
  ...
  const tiltX = (relativeY - 0.5) * 10; // increase for better feel
  ...
  return (
    <section className='bg-black pb-52'>
     ...
     <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
        <BentoCard
          src="/videos/feature-1-fixed.mp4"
          title={<>radia<b>n</b>t</>}
       ...
       <div className=" grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <BentoCard
           src="/videos/feature-2-fixed.mp4"
            title={<>zig<b>m</b>a</>}
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
           <BentoCard
            src="/videos/feature-3-fixed.mp4"
            title={<>n<b>e</b>xus</>}
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
           <BentoCard
            src="/videos/feature-4-fixed.mp4"
            title={<>az<b>u</b>l</>}
        ...
        <BentoTilt className="bento-tilt_2"> 
          ...
          <BentoTilt className="bento-tilt_2">
          <video
            src="/videos/feature-5-fixed.mp4"
            loop
            muted
            autoPlay
